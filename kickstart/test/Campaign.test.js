...
beforeEach(async () => {
  ...
  // Above is equivalent to setting result to array of addresses and setting `campaignAddress` to item 0
...
describe('Campaigns', () => {
  ...
  it('processes requests', async () => {
    const initialBalance = parseFloat(web3.utils.fromWei(await web3.eth.getBalance(accounts[1]), 'ether'));
